...
?><select
	aria-label="<?php esc_attr( _e( $atts['aria'], 'now-AmateurLogBook' ) ); ?>"
...
if ( ! empty( $atts['blank'] ) ) {
	...
	?><option value><?php esc_html_e( $atts['blank'], 'now-AmateurLogBook' ); ?></option><?php
...
foreach ( $atts['selections'] as $selection ) {
	...
	?><option
		...
		esc_html_e( $label, 'now-AmateurLogBook' );
...
?></select>
<span class="description"><?php esc_html_e( $atts['description'], 'now-AmateurLogBook' ); ?></span>
</label>
