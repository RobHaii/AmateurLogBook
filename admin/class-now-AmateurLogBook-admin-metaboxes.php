 ...
 */
class AmateurLogBook_Admin_Metaboxes {
	...
	public function add_metaboxes() {
		...
		add_meta_box(
			...
			apply_filters( $this->plugin_name . '-metabox-title-additional-info', esc_html__( 'Additional Info', 'now-AmateurLogBook' ) ),
			array( $this, 'metabox' ),
			'job',
			'normal',
			'default',
		...
		add_meta_box(
			...
			apply_filters( $this->plugin_name . '-metabox-title-requirements', esc_html__( 'Job Requirements', 'now-AmateurLogBook' ) ),
			array( $this, 'metabox' ),
			'job',
			'normal',
			'default',
		...
		add_meta_box(
			...
			apply_filters( $this->plugin_name . '-metabox-title-requirements', esc_html__( 'Related Files', 'now-AmateurLogBook' ) ),
			array( $this, 'metabox' ),
			'job',
			'side',
			'default',
	...
	public function metabox( $post, $params ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'partials/now-AmateurLogBook-admin-metabox-' . $params['args']['file'] . '.php' );
	...
	public function save_files_order() {
		...
		check_ajax_referer( 'now-AmateurLogBook-file-order-nonce', 'fileordernonce' );
		...
		esc_html_e( 'File order saved.', 'now-AmateurLogBook' );
