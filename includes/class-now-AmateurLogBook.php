...
class AmateurLogBook {
	...
	public function __construct() {
		...
		$this->plugin_name = 'now-AmateurLogBook';
		$this->version = '1.0.0';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-now-AmateurLogBook-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-now-AmateurLogBook-i18n.php';
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-now-AmateurLogBook-admin-metaboxes.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-now-AmateurLogBook-public.php';

		/**
		 * The class responsible for defining all actions creating the templates.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-now-AmateurLogBook-template-functions.php';

		/**
		 * The class responsible for all global functions.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-now-AmateurLogBook-functions.php';

		/**
		 * The class responsible for defining all actions shared by the Dashboard and public-facing sides.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-now-AmateurLogBook-shared.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-now-AmateurLogBook-widget.php';

		/**
		 * The class responsible for sanitizing user input
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-now-AmateurLogBook-sanitize.php';

		$this->loader = new AmateurLogBook_Loader();
		$this->sanitizer = new AmateurLogBook_Sanitize();
	...
	private function set_locale() {
		...
		$plugin_i18n = new AmateurLogBook_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new AmateurLogBook_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_template_hooks() {
		...
		// Loop
		$this->loader->add_action( 'now-AmateurLogBook-before-loop', $plugin_templates, 'list_wrap_start', 10 );
		$this->loader->add_action( 'now-AmateurLogBook-before-loop-content', $plugin_templates, 'content_wrap_start', 10, 2 );
		$this->loader->add_action( 'now-AmateurLogBook-before-loop-content', $plugin_templates, 'content_link_start', 15, 2 );
		$this->loader->add_action( 'now-AmateurLogBook-loop-content', $plugin_templates, 'content_job_title', 10, 2 );
		$this->loader->add_action( 'now-AmateurLogBook-after-loop-content', $plugin_templates, 'content_link_end', 10, 2 );
		$this->loader->add_action( 'now-AmateurLogBook-after-loop-content', $plugin_templates, 'content_wrap_end', 90, 2 );
		$this->loader->add_action( 'now-AmateurLogBook-after-loop', $plugin_templates, 'list_wrap_end', 10 );

		// Single
		$this->loader->add_action( 'now-AmateurLogBook-single-content', $plugin_templates, 'single_post_title', 10 );
		$this->loader->add_action( 'now-AmateurLogBook-single-content', $plugin_templates, 'single_post_content', 15 );
		$this->loader->add_action( 'now-AmateurLogBook-single-content', $plugin_templates, 'single_post_responsibilities', 20 );
		$this->loader->add_action( 'now-AmateurLogBook-single-content', $plugin_templates, 'single_post_location', 25 );
		$this->loader->add_action( 'now-AmateurLogBook-single-content', $plugin_templates, 'single_post_education', 30 );
		$this->loader->add_action( 'now-AmateurLogBook-single-content', $plugin_templates, 'single_post_skills', 35 );
		$this->loader->add_action( 'now-AmateurLogBook-single-content', $plugin_templates, 'single_post_experience', 40 );
		$this->loader->add_action( 'now-AmateurLogBook-single-content', $plugin_templates, 'single_post_info', 45 );
		$this->loader->add_action( 'now-AmateurLogBook-single-content', $plugin_templates, 'single_post_file', 50 );
		$this->loader->add_action( 'now-AmateurLogBook-after-single', $plugin_templates, 'single_post_how_to_apply', 10 );
	...
	private function define_shared_hooks() {
		...
		$plugin_shared = new AmateurLogBook_Shared( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_metabox_hooks() {
		...
		$plugin_metaboxes = new AmateurLogBook_Admin_Metaboxes( $this->get_plugin_name(), $this->get_version() );
