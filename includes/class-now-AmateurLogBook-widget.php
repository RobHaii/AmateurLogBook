 ...
 */
class AmateurLogBook_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$name 					= esc_html__( 'Now Hiring', 'now-AmateurLogBook' );
		$opts['classname'] 		= '';
		$opts['description'] 	= esc_html__( 'Display job postings on a sidebar', 'now-AmateurLogBook' );
	...
	function widget( $args, $instance ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'partials/now-AmateurLogBook-display-widget.php' );
