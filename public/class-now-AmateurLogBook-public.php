...
class Now_Hiring_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/now-AmateurLogBook-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/now-AmateurLogBook-public.js', array( 'jquery' ), $this->version, true );
	...
	public function how_to_apply() {
		...
		include now_hiring_get_template( 'now-AmateurLogBook-how-to-apply' );
