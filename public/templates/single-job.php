...
if ( have_posts() ) :
	...
	/**
	 * now-AmateurLogBook-single-before-loop hook
	 *
	 * @hooked 		job_single_content_wrap_start 		10
	 */
	do_action( 'now-AmateurLogBook-single-before-loop' );
	...
	/**
	 * now-AmateurLogBook-single-after-loop hook
	 *
	 * @hooked 		job_single_content_wrap_end 		90
	 */
	do_action( 'now-AmateurLogBook-single-after-loop' );
